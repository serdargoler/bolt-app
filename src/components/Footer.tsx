    ...
    <footer className="bg-navy text-white pt-16 pb-8" style={{ backgroundColor: '#001f3f' }}>
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-xl font-semibold mb-4">{t(TRANSLATION_KEYS.FOOTER.QUICK_LINKS)}</h3>
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-xl font-semibold mb-4">{t(TRANSLATION_KEYS.FOOTER.FOLLOW_US)}</h3>
        ...
        <div className="border-t border-gray-700 pt-8 mt-8 text-center">
          <p>&copy; {new Date().getFullYear()} Horizon Poland. {t(TRANSLATION_KEYS.FOOTER.ALL_RIGHTS_RESERVED)}</p>
        </div>
      </div>
    </footer>
  );
